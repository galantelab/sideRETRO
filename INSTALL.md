...
The following instructions were taken from [Meson quick guide](https://mesonbuild.com/Quick-guide.html)
and are released under [Creative Commons Attribution-ShareAlike 4.0 International](https://creativecommons.org/licenses/by-sa/4.0/).

For more details, please visit [Meson website](https://mesonbuild.com/).
